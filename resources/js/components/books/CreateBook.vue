        ...
        <div class="col-12">
          <div class="card my-4">
            ...
            <div class="card-body ">
                <div class="row">
                    <div class="col-md-7">
                        <form @submit.prevent="addBook" role="form">
                         <label class="form-label">Book Name</label>
                            <div class="input-group input-group-outline mb-3">                           
                            <input type="text" class="form-control" v-model="book.bookname">
                            </div>
                            <label class="form-label">Book Author</label>
                            <div class="input-group input-group-outline mb-3">
                            <input type="text" class="form-control" v-model="book.authorname">
                            </div>     
...
export default {
    ...
    methods: {
        addBook(){            
            this.axios.post('/api/savebook/', this.book)
            .then(
                response=>(
